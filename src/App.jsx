...
const enriched = { …info, shares: stock.shares, avgCost: stock.avgCost };
const text = await analyzeWithClaude(enriched, type);
...
{loading ? <div style={{ textAlign: “center”, padding: “2rem”, color: “#8b949e” }}><div style={{ fontSize: “1.5rem”, marginBottom: “0.5rem” }}>⟳</div><div style={{ fontSize: “0.85rem” }}>AI กำลังวิเคราะห์…</div></div>
...
{quote && (
<>
<div style={{ color: “#8b949e”, fontSize: “0.75rem”, marginBottom: “0.4rem”, marginTop: “0.25rem” }}>📊 Portfolio (ไม่บังคับ)</div>
<div style={{ display: “flex”, gap: “0.5rem”, marginBottom: “0.5rem” }}>
...
<input value={target} onChange={e => setTarget(e.target.value)} placeholder=“Target price” type=“number” style={{ width: “100%”, background: “#161b22”, border: “1px solid #30363d”, color: “#e6edf3”, borderRadius: “6px”, padding: “6px 10px”, fontSize: “0.82rem”, marginBottom: “0.4rem”, boxSizing: “border-box” }} />
<textarea value={note} onChange={e => setNote(e.target.value)} placeholder=“Note…” rows={2} style={{ width: “100%”, background: “#161b22”, border: “1px solid #30363d”, color: “#e6edf3”, borderRadius: “6px”, padding: “6px 10px”, fontSize: “0.82rem”, resize: “none”, marginBottom: “0.4rem”, boxSizing: “border-box” }} />
...
<style>{`@import url('https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600;700&display=swap'); * { box-sizing: border-box; margin: 0; padding: 0; } input::placeholder, textarea::placeholder { color: #484f58; }`}</style>
