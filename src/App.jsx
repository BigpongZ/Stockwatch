      ...
      <div style={{ background: "#0d1117", border: "1px solid #21262d", borderRadius: "16px", width: "100%", maxWidth: "600px", maxHeight: "90vh", overflow: "auto", boxShadow: "0 0 60px rgba(0,212,170,0.15)" }}>
        ...
        <div style={{ padding: "1.5rem" }}>
          {loading ? (
            ...
            <div style={{ color: "#c9d1d9", lineHeight: 1.8, fontSize: "0.9rem", whiteSpace: "pre-wrap" }}>{result[tab]}</div>
          ) : null}
        </div>
      </div>
    </div>
...
function AddStockModal({ onAdd, onClose }) {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.85)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1000, padding: "1rem" }}>
      <div style={{ background: "#0d1117", border: "1px solid #21262d", borderRadius: "16px", width: "100%", maxWidth: "440px", padding: "1.5rem" }}>
        ...
        {quote && (
          <>
            ...
            <textarea placeholder="Note / เหตุผลที่ดูหุ้นนี้..." value={note} onChange={e => setNote(e.target.value)} rows={3} style={{ width: "100%", background: "#161b22", border: "1px solid #30363d", color: "#e6edf3", borderRadius: "8px", padding: "8px 12px", fontSize: "0.88rem", resize: "none", marginBottom: "1rem", boxSizing: "border-box" }} />
...
function StockCard({ item, onRemove, onAnalyze, onUpdate }) {
  ...
  return (
    <div style={{ background: "#0d1117", border: "1px solid #21262d", borderRadius: "14px", padding: "1.1rem" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
        <div>
