...
async function analyzeStock(stockInfo, analysisType) {
  ...
  const prompts = {
    ...
    news: `Recent news and sentiment for ${stockInfo.symbol} (${stockInfo.market === "TH" ? "Thai" : "US"} stock). ${portfolioContext} Key catalysts or risks in 3-4 sentences. End with BUY / HOLD / SELL.`,
  };
  try {
